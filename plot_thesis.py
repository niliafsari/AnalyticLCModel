...
y = np.zeros_like(X)
y[1:] = h.repeat(2)
ax0.plot(X,y,color='#1f77b4',lw=2,label='Arnett',ls='--')
...
y[1:] = h.repeat(2)
y_s=y
ax0.plot(X,y,color='#1f77b4',lw=2,label='KK19',ls=':')
y=np.arange(0,1.1,0.01)
...
# ax3.set_ylim([0, 1])
ax0.set_xlabel(r'$M_{\rm Ni} (M_\odot$)',fontsize=18)
...
plt.gcf().savefig('/home/afsari/PycharmProjects/typeIbcAnalysis/Plots/cdf_thesis.pdf', bbox_inches='tight')
